...
public class stopwords {
	...
	public static String removeStopwords(String input){
	    ...
	    stopWords.add("paper's");
	    stopWords.add("approach");
	    stopWords.add("approaches");
	...
	public static void main(String args[]){
		...
		String inputText= stopwords.removeStopwords("The 32 GB Smartphone is a cutting-edge smartphone for users who demand excellence in mobile ");
	    double start=System.currentTimeMillis();
		String abc=removeStopwords(inputText);
